		...
		<div className=''>
			...
			>
				...
				>
					...
					<div className='bubble'>
						<TbBrandPython size={28} title='Python' />
					...
					<div className='bubble'>
						<SiSnowflake size={28} title='Snowflake' />
						<Label className='text-[10px]'>MS Snowflake</Label>
					</div>
					<div className='bubble'>
						<HiOutlineCommandLine size={28} title='Command Line' />
						<Label className='text-[10px]'>CLI</Label>
					</div>
				</motion.div>
			</motion.section>
		</div>
