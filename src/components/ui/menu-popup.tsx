...
export const MenuItem = ({
	...
	return (
		<TextureButton onMouseEnter={() => setActive(item)} className='z-10'>
			<motion.p
				transition={{ duration: 0.5 }}
				className='cursor-pointer  font-bold hover:opacity-[0.9]'
			>
				{item}
			</motion.p>
			{active !== null && (
				...
				>
					{active === item && (
						<div className='absolute w-[20rem] h-[15rem] top-[calc(100%_+_1.2rem)] left-1/2 transform -translate-x-1/2 z-50'>
							<motion.div
								transition={transition}
